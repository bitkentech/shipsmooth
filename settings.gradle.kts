...
// docker: shipsmooth-claude image build tooling (plan-113), folded in from a
// standalone build repo. No internal deps — it consumes the *published* plugin,
// not the build graph. Its outward task (buildAndPush) is wired-only.
