...
@template.skills.shared.workflow.linear-structure(model = model)
@template.skills.shared.workflow.phase1-plan(model = model)
@template.skills.shared.workflow.phase2-execute(model = model)
@template.skills.shared.workflow.plan-closeout(model = model)
@template.skills.shared.workflow.audit-trail(model = model)