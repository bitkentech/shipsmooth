...
final class TomlSchemaValidator {
    ...
    private String typeName(Object value) {
        return switch (value) {
            ...
            case OffsetDateTime odt -> "offset-date-time";
            case LocalDateTime ldt -> "local-date-time";
            case LocalDate ld -> "local-date";
            case LocalTime lt -> "local-time";
            case TomlArray arr -> "array";
            case TomlTable tbl -> "table";
