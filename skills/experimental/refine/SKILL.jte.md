...
`.shipsmooth/tmp/refine-<target>.md` (where `<target>` names the file or folder being refined).
...
**Begin by re-reading the `.shipsmooth/tmp/refine-<target>.md` scratchpad** and treat it as the
...
@template.experimental.refine.rules.rich-domain(model = model)
@template.experimental.refine.rules.class-structure(model = model)
@template.experimental.refine.rules.srp(model = model)
@template.experimental.refine.rules.single-source(model = model)
@template.experimental.refine.rules.constructor-di(model = model)
@template.experimental.refine.rules.private-final-fields(model = model)
@template.experimental.refine.rules.avoid-primitives(model = model)
@template.experimental.refine.rules.static-rare(model = model)
@template.experimental.refine.rules.method-ordering(model = model)
@template.experimental.refine.rules.method-structure(model = model)
@template.experimental.refine.rules.ternaries-booleans(model = model)
@template.experimental.refine.rules.package-structure(model = model)
@template.experimental.refine.rules.method-length(model = model)
@template.experimental.refine.rules.if-block-length(model = model)
@template.experimental.refine.rules.if-nesting(model = model)
@template.experimental.refine.rules.file-length(model = model)