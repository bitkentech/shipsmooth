...
public class LedgerRecordCommit implements Callable<Integer>, HasSpec, io.bitken.shipsmooth.tasks.stability.FeatureFlags {
    ...
    @Inject
    public LedgerRecordCommit(LedgerService ledger) {
